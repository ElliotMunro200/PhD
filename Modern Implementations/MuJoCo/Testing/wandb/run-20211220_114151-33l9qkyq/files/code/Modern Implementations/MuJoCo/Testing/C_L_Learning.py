...
if __name__ == "__main__":
    ...
    print(inspect.getmembers(env.action_spec, inspect.ismethod))
    print(inspect.getmembers(env.close, inspect.ismethod))
    print(inspect.getmembers(env.control_timestep, inspect.ismethod))
    print(inspect.getmembers(env.discount_spec, inspect.ismethod))
    print(inspect.getmembers(env.observation_spec, inspect.ismethod))
    print(inspect.getmembers(env.reset, inspect.ismethod))
    print(inspect.getmembers(env.reward_spec, inspect.ismethod))
    print(inspect.getmembers(env.step, inspect.ismethod))
    print(inspect.getmembers(env.step_spec, inspect.ismethod))
