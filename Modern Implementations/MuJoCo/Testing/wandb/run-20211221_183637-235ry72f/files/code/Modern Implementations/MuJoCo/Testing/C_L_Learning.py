...
if __name__ == "__main__":
    ...
    env = suite.load('cartpole', 'balance', task_kwargs={'time_limit': 10, 'random': random_state}) #suite.load is in suite.__init__.py
    ...
    num_outputs = 2  # number of CartPole action variables
    ...
    num_frames = config["num_total_frames"]
